...
while True:
    ...
    if len(lm_list) != 0:
        ...
        cv2.circle(
            img, tuple(map(int, index_finger_tip[1:])), 10, (0, 255, 0), cv2.FILLED
        )
    ...
    cv2.putText(
        img, str(int(fps)), (10, 60), cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 255), 2
    )
    cv2.putText(
        img, "Press 's' to exit.", (10, 30), cv2.FONT_HERSHEY_PLAIN, 1, (0, 0, 255), 1
    )

    cv2.rectangle(
        img, (OFFSET, OFFSET), (WIDTH - OFFSET, HEIGHT - OFFSET), (255, 0, 255), 2
    )
